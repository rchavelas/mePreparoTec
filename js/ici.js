...
const B2HTML =  "<span class='tooltip' data-text='Si no se ofrece, esta UF es equivalente a las F1002B, F1004B o F1006B. Consulta a tu asesor académico para conocer la mejor opción'>3 UdC | F1008B: Modelación del movimiento en ciencias</span>" 
...
const B3HTML =  "<span class='tooltip' data-text='Si no se ofrece, esta UF es equivalente a las F1003B, F1005B o F1007B. Consulta a tu asesor académico para conocer la mejor opción'>3 UdC | F1009B: Aplicación de las leyes de conservación en ciencias</span>" 
...
const html_M1P3 = "<span class='tooltip' data-text='Referencia: Q1029 (Análisis de la estructura y transformación de la materia) y Q1033 (Pensamiento computacional orientado a objetos)'>1 UdC | Q1029 si tu carrera es INA o IFI y TC1033 si tu carrera es IDM</span>"
