...
function agregarWA1057(params) {
    ...
    sidebarList.appendChild(liWA1057);
}
...
EG1P1.addEventListener("click",function(){
    if(EG1P1.classList.contains("active")){
        ...
        credsSeleccionados+=3;
        actualizarDom();
        addToList("EG1","3 UdC | Optativa de Educación General")     
    };
});
...
inputLife1.addEventListener("focusout",function(){
    let hasChild = sidebarList.querySelector("#inputLife1_lielem");
    if(hasChild != null){
        sidebarList.removeChild(hasChild)
    }   
    if(inputLife1.value !== ""){
        let liElement = document.createElement("li")
...
inputLife2.addEventListener("focusout",function(){
    let hasChild = sidebarList.querySelector("#inputLife2_lielem");
    if(hasChild != null){
        sidebarList.removeChild(hasChild)
    }   
    if(inputLife2.value !== ""){
...
inputLife3.addEventListener("focusout",function(){
    let hasChild = sidebarList.querySelector("#inputLife3_lielem");
    if(hasChild != null){
        sidebarList.removeChild(hasChild)
    }   
    if(inputLife3.value !== ""){
